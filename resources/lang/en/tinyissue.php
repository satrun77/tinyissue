...
return [
    ...
    'limit_message_help'                 => 'To limit tag messages to the selected role and the roles above it.',
    'message'                            => 'Message',
    'messages'                           => 'Messages',
    'my_messages_settings_description'   => 'Update your personal messages settings',
    'my_messages_settings'               => 'My messages settings',
    'messages_settings_updated'          => 'Messages settings updated',
    'messages_disabled_help'             => 'Disable all of the messages. (Default for Administrators)',
    'messages_minimum_help'              => 'Issue, tag changes in issues that I\'m involved in as creator or assignee. (Default for Users)',
    'messages_standard_help'             => 'Issue, tag, comment, note changes in issues that I\'m involved in as creator or assignee. (Default for Developers)',
    'messages_full_help'                 => 'Issue, tag, comment, note changes in every issues of this project.  (Default for Managers)',
    'assignee'                           => 'Assignee',
    'change_by'                          => 'Change By',
    'body'                               => 'Body',
